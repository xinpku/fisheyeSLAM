...
namespace ORB_SLAM2
{
                                     ...
                                     int nIterations, bool* pbStopFlag, const unsigned long nLoopKF, const bool bRobust)
    {
        ...
        for(size_t i=0; i<vpMP.size(); i++)
        {
            ...
            for(map<KeyFrame*,size_t>::const_iterator mit=observations.begin(); mit!=observations.end(); mit++)
            {
                ...
                int cameraID = pKF->mvCamera_Id_KeysUn[mit->second];
                ...
                if(pKF->mvuRight[mit->second]<0)
                {
                    ...
                    EdgeSE3ProjectXYZGroupCamera* e = new EdgeSE3ProjectXYZGroupCamera();
    ...
    int Optimizer::PoseOptimizationGroupCamera(Frame *pFrame)
    {
        ...
        vector<EdgeSE3ProjectXYZOnlyPoseGroupCamera*> vpEdgesMono;
...

        {
            ...
            for(int i=0; i<N; i++)
            {
                ...
                int cameraID = pFrame->mvCamera_Id_KeysUn[i];
                if(pMP)
                {
                    ...
                    if(pFrame->mvuRight[i]<0)
                    {
                        ...
                        EdgeSE3ProjectXYZOnlyPoseGroupCamera* e = new EdgeSE3ProjectXYZOnlyPoseGroupCamera();
        ...
        const float chi2Mono[4]={4.591,3.591,2.591,1.591};
    ...
    void Optimizer::LocalBundleAdjustmentGroupCamera(KeyFrame *pKF, bool* pbStopFlag, Map* pMap)
    {
        ...
        vector<EdgeSE3ProjectXYZGroupCamera*> vpEdgesMono;
        ...
        for(list<MapPoint*>::iterator lit=lLocalMapPoints.begin(), lend=lLocalMapPoints.end(); lit!=lend; lit++)
        {
            ...
            {
                KeyFrame* pKFi = mit->first;
                int cameraID = pKFi->mvCamera_Id_KeysUn[mit->second];
                if(!pKFi->isBad())
                {
        ...
        if(bDoMore)
        {
            ...
            for(size_t i=0, iend=vpEdgesMono.size(); i<iend;i++)
            {
                EdgeSE3ProjectXYZGroupCamera* e = vpEdgesMono[i];
